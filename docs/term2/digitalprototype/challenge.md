...
The MOC has still the same concept but now it is portable, meaning you can get your “stickers” (or versions of this guerrilla system) anywhere in the world. So, one goes from the “city of Barcelona is the Museum of Colonization” to “the world is the Museum of Colonization”. It can seem like a careless generalization if one’s fonts of knowledge were only History classes in our sterilized and stiff school curriculums. But, once one gets a bit deeper and adds critical thinking the message is clear. The European expeditions in search of the “New World” initiated the homogenization of the Globe (cultural, ecological, and racial) and started a globalized network known as the Atlantic Slave Trade. So, yes the MOC is global because colonization is a systemic global problem.

...
![mapping 1](../../images/community/map.png)
...
***Keywords: Community, Engagement, Listening, Power, Invisibility, Inequality, Diversity, Representation, Mapping, Togetherness, Action, Money, Power, Facilitating, Conflict Management, Futures Literacy.***
From these keywords, I focused on developing some further research on Community Mapping, Power Dynamics, Power Dynamics, and Futures Literacy, basing it all on what we learned this week.
...
![mapping 3](../../images/community/creativecommunity.png)
...
It highlights how difficult but how necessary it is to have class-based diversity within power positions. The community-driven professional goals of BIPOC folks are well represented in this example given by Neil deGrasse (Astrophysicist) when one of his (black) friends says: “Astrophysics? The black community cannot afford the luxury of someone of your intellect to spend it on that subject.” Making him feel guilty about not doing enough to help others. You can watch the full video here: [A Story About Race Neil deGrasse Tyson - YouTube](https://www.youtube.com/watch?v=eQLtPWPqsjA). Not to say that every BIPOC struggle is due to our conception of power, it is much more complex, but it is freeing to detach evilness from power and move forward without that guilt.

![mapping 2](../../images/community/map2.png)
...
Design can be hopeful and open doors to new realities that are non-western centric: [Diébédo Francis Kéré: How to build with clay... and community - YouTube](https://www.youtube.com/watch?v=MD23gIlr52Y)
...
As we moved into the assignments related to Design Dialogues this particular theme shined the brighter and reminded me of what Ron Wakkary said during his lecture: “It’s impossible to be inclusionary but it is possible to be tentacular and collective in our design.” Since then, together with the group Augmented Creativity - Myrto, Stella, Paige, Mariana and I - decided to join forces to bring in order to explore the following question: How to facilitate interactions with something that is more than human?
